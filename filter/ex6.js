...
let filterOffensiveComments = (comments, bannedWords) => comments.filter(a => (a.toLowerCase().includes(bannedWords[0]) || a.toLowerCase().includes(bannedWords[1])) ? false : true)
